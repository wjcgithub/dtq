...
task_queues = {
    'xin2_emails': {
        'exchange': 'first',
        'routing_key': 'xin2_emails',
    },
}
task_routes = {
    'emails.task.handler': {'queue': 'xin2_emails', 'exchange': 'first', 'routing_key': 'xin2_emails'},
}
result_expires = 3600
...
worker_state_db='/home/evolution/PycharmProjects/celery_project/programs/log/xin2/emails/emails'
