...
task_queues = {
    'xin2_fast': {
        'exchange': 'first',
        'routing_key': 'xin2_fast',
    },
}
task_routes = {
    'fast.task.handler': {'queue': 'xin2_fast', 'exchange': 'first', 'routing_key': 'xin2_fast'},
}
result_expires = 3600
...
worker_state_db='/home/evolution/PycharmProjects/celery_project/programs/log/xin2/fast/fast'
