...
task_queues = {
    'xin2_login': {
        'exchange': 'first',
        'routing_key': 'xin2_login',
    },
}
task_routes = {
    'login.task.handler': {'queue': 'xin2_login', 'exchange': 'first', 'routing_key': 'xin2_login'},
}
result_expires = 3600
...
worker_state_db='/home/evolution/PycharmProjects/celery_project/programs/log/xin2/login/login'
