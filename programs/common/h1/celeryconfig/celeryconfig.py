...
task_queues = {
    'common_h1': {
        'exchange': 'first',
        'routing_key': 'common_h1',
    },
}
task_routes = {
    'h1.task.handler': {'queue': 'common_h1', 'exchange': 'first', 'routing_key': 'common_h1'},
}
result_expires = 3600
...
worker_state_db='/home/evolution/PycharmProjects/celery_project/programs/log/common/h1/h1'
