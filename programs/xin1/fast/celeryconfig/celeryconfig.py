...
task_queues = {
    'xin1_fast': {
        'exchange': 'first',
        'routing_key': 'xin1_fast',
    },
}
task_routes = {
    'fast.task.handler': {'queue': 'xin1_fast', 'exchange': 'first', 'routing_key': 'xin1_fast'},
}
result_expires = 3600
...
worker_state_db='/home/evolution/PycharmProjects/celery_project/programs/log/xin1/fast/fast'
